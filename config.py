...
# Bot and owner info
OWNER_USERNAME = getenv("OWNER_USERNAME", "your_aadiii")
BOT_USERNAME = getenv("BOT_USERNAME", "your_aadiii")
...
LOGGER_ID = int(getenv("LOGGER_ID", -1004293212612))
OWNER_ID = int(getenv("OWNER_ID", 7619471041))
...
# Git
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/ankitop0086-alt/STAKE-MUSIC")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", None)

# Support
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/yourr_adiii")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+e4OBbdsY0kdlZTk9")
...
PING_IMG_URL = getenv("PING_IMG_URL", "https://files.catbox.moe/qhgr50.jpg")
...
SHASHANK_IMG = [
    "https://files.catbox.moe/xl9xtz.jpg",
    "https://files.catbox.moe/ihzn6r.jpg",
    "https://files.catbox.moe/vl8ad7.jpg",
    "https://files.catbox.moe/8r7k6f.jpg",
    "https://files.catbox.moe/29u5kz.jpg",
    "https://files.catbox.moe/r1k8hb.jpg",
    "https://files.catbox.moe/qhgr50.jpg"
]
